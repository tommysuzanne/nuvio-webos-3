# Nuvio sur LG UJ630 — port communautaire

[English / documentation principale](README.md)

Ce dépôt partage les adaptations de Nuvio 1.1.2 pour une LG 49UJ630V-ZA : interface 1080p, collections et Reprendre, navigation virtualisée, caches bornés, annulation réseau, écrans chargés à la demande, accents corrigés et sources 4K prioritaires.

- Les collections se gèrent depuis un autre appareil ; la TV les reçoit en lecture seule.
...
Sources sous GPLv3. Merci aux auteurs de NuvioMedia/NuvioTVSmart et du port legacy d'iqui27 : ce travail repose sur leurs contributions.
