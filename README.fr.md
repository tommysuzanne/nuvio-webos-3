...
**[Télécharger l’IPK](https://github.com/tommysuzanne/nuvio-webos-3/releases/latest)** · [Installer](docs/UJ630/INSTALLATION.md) · [Compatibilité](docs/COMPATIBILITY.md) · [Nouveautés](docs/UJ630/RELEASE-45.md#nouveautés-en-français) · [English](README.md)
...
**Nouveautés de la version45 :** navigation Bibliothèque débloquée, chargement sélectif des avatars et fonds, historique des fiches et caches de sous-titres bornés, images libérées pendant les bandes-annonces. [Détails et mise à jour](docs/UJ630/RELEASE-45.md#nouveautés-en-français).
...
| Téléviseur | Statut |
| --- | --- |
| **LG 49UJ630V-ZA**, UHD, firmware 06.10.75 | Installation testée ; contrôles navigation, ressources et bandes-annonces sur les candidats personnels45 réussis. Limites ci-dessous. |
...
Le seuil p99 révisé est de 35 ms ; les échecs au seuil initial de 33 ms restent documentés. Les candidats personnels45 ont reçu 40 cycles de navigation sur RC3, puis trois cycles et un contrôle de bande-annonce sur RC4 final, avec des miniatures privées. **Le paquet public téléchargeable n’a pas reçu de qualification TV complète distincte.** La stabilité mémoire prolongée, l’avance précise HEVC et la couverture complète veille/redémarrage restent à valider.

**48 groupes de régression UJ630 et 102 tests JavaScript natifs**, plus les contrôles de construction/compatibilité, tournent en CI. Cela ne prouve pas le « zéro lag ». [Mesures complètes, gains du refactor et limites](docs/UJ630/VALIDATION.md).

[Gestion des ressources et limites mémoire](docs/UJ630/RESOURCE-LIFECYCLE.md) (documentation technique en anglais).
