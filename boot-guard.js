...
// XHR-backed whatwg-fetch observes this signal and really aborts the transport.
(function (root) {
  if (typeof root.AbortController === "function") return;
  function Controller() {
    var listeners = [];
    ...
    this.abort = function () {
      ...
      var copy = listeners.slice(); listeners.length = 0;
      for (var i = 0; i < copy.length; i++) copy[i]();
    };
  }
  root.AbortController = Controller;
})(window);

(function () {
  if (typeof Node !== "undefined" && !("isConnected" in Node.prototype)) {
    Object.defineProperty(Node.prototype, "isConnected", {get:function () {
      return !!(this.ownerDocument && this.ownerDocument.documentElement.contains(this));
    }});
  }
})();
